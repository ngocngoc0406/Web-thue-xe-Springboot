		...
		if (sessionUser == null) {
			...
			if (vnp_ResponseCode.equals("00")) {
				...
				try {
					...
					System.err.println(
							u.getTotalMoney() + booking.getBillTotal() - (booking.getBillTotal() * SYSTEM_DISCOUNT));
					double newTotalMoney = u.getTotalMoney() + booking.getBillTotal()
							- (booking.getBillTotal() * SYSTEM_DISCOUNT);
